...
public class TextureGenerator : MonoBehaviour
{
    ...
    [SerializeField, Tooltip("Short description of what the model should not look like.")]
    private string negativeModelDescription;
    ...
    [SerializeField, Tooltip("Size of the texture map, define the visual quality. Default: 512")]
